...
if((trim($email) == '')&&(trim($phone) == '')) {
	echo '<div class="error_message">Attention! Please enter a valid email address or a valid phone number.</div>';
	exit();
...
$comments = "Which regimen would you like to receive?$regimen, Mobile number:$phone";
